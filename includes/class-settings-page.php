...
class CAF_Settings_Page {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      CAF_Settings_Page_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'CAF_SETTINGS_PAGE_VERSION' ) ) {
			$this->version = CAF_SETTINGS_PAGE_VERSION;
		} else {
			$this->version = '1.0.0'; // if no version set, show 1.0.0
		}
	...
	private function load_dependencies() {
		...
		$this->loader = new CAF_Settings_Page_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new CAF_Settings_Page_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new CAF_Settings_Page_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new CAF_Settings_Page_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    CAF_Settings_Page_Loader    Orchestrates the hooks of the plugin.
	 */
